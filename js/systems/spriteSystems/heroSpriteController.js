    ...
    updateAnim(direction, action) {
        switch (action) {
            ...
            case 'charged_attack':
                switch (direction) {
                    case 'up':
                        this.animation.play('charged_attack_up');
                        break;
                    case 'left':
                        this.animation.play('charged_attack_left');
                        break;
                    case 'right':
                        this.animation.play('charged_attack_right');
                        break;
                    case 'down':
                        this.animation.play('charged_attack_down');
                        break;
                }
                break;
            case 'pick_up':
